...
Probably for the NOT newcomers, it can be mixed with "reuse TW computing fundamentals" topic.
...
**Status:**
To be merged into the instagram account
...
**Status:**
The scope of this initative is for regular workshops.
Combining specific workshops and extra regular workshops might be to much.
Could we incour in couch burnout?
It is an opportunity for doing it in different languages (spanish / catalan), maybe with this we can rely on different coaches.
We can invest in promoting what a coach is and how it can be useful for organizations to promote.

We need to work further on define what is what we want. We need to gather intel from coaches, students, hosts.
Survey time for mid september?. Is it ok to use the codebar mailing list for the surveys?
...
There is a Donate button in the codebar page, it is possible to communicate with Codebar the donations that are donated for the barcelona chapter for this purpose.
...
TW computer fundamentals is for advanced topics. We do not know if the students would be interested in it.

Facilitator sends this topic to the **parking lot**
